...
public class ErrorReportLibraryUtil {
    ...
    public static ErrorReportLibraryParseVo parseAssertions(RequestResult result) {
        ErrorReportLibraryParseVo returnDTO = new ErrorReportLibraryParseVo();
        ...
        if (MapUtils.isNotEmpty(errorReportAssertionMap)) {
            ...
            if (MapUtils.isNotEmpty(errorReportAssertionMap)) {
                if (MapUtils.isNotEmpty(errorAssertionMap)) {
                    if (higherThanError) {
                        result.requestStatus = ExecuteResultEnum.ERROR_REPORT_RESULT.toString();
                    }
